module.exports = ({ theme }) => ({
  DEFAULT: {
    css: {
      ...
      '--tw-prose-links': theme('colors.brand.100'),
      '--tw-prose-links-hover': theme('colors.brand.200'),
      '--tw-prose-links-underline': theme('colors.brand.100 / 0.3'),
      ...
      '--tw-prose-invert-links-hover': theme('colors.brand.200'),
      '--tw-prose-invert-links-underline': theme('colors.brand.100 / 0.3'),
