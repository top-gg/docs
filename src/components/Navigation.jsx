...
function ActivePageMarker({ group, pathname }) {
  ...
  return (
    <motion.div
      layout
      className="absolute left-2 h-6 w-px bg-[#ff3366]"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1, transition: { delay: 0.2 } }}
      exit={{ opacity: 0 }}
      style={{ top }}
...
export const navigation = [
  ...
  },
  {
    title: 'Resources',
    links: [
      { title: 'Ratelimits', href: '/resources/ratelimits' },
      { title: 'Webhooks', href: '/resources/webhooks' }
    ],
  },
  {
    title: 'Libraries',
    links: [
      { title: 'Dotnet', href: '/libraries/dotnet' },
      { title: 'Go', href: '/libraries/go' },
      { title: 'Java', href: '/libraries/java' },
