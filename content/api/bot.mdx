...
<HTTPHeader type="GET" path="/bot/:bot_id" />
...
| ------------ | ---------------------- | ------------------------------------------------------------------------------------------------- | -------------------- |
| server_count | `number` \| `number[]` | Amount of servers the bot is in. If an Array, it acts like shards                                 | ✔️ (or shards)       |
| shards       | `number[]`             | Amount of servers the bot is in per shard.                                                        | ❌ (or server_count) |
