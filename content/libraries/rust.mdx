---
title: Rust
description: A community maintained Top.gg Rust Library
---

# Rust Library

The community-maintained Rust Library for Top.gg. If you experience any issues/bugs please submit an issue on Github.

- [GitHub Link](https://github.com/top-gg/rust-sdk)
...
### Writing an [actix-web](https://crates.io/crates/actix-web) webhook for listening to your bot/server's vote events
